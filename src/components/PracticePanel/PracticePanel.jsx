...
// Practice controls: reset, the round settings, and the learning aids.
// Leaving practice uses the HUD gear drawer, like every other mode.
export default function PracticePanel() {
  ...
  return (
    <section className={styles.panel} aria-label="Practice options">
      <div className={styles.row}>
        ...
        <button className={styles.reset} onClick={resetPracticeRound}>
          Reset round
        </button>
      </div>
